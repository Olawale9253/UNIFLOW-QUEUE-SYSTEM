...
function AdminLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            {/* Admin Navbar - Clean, no profile avatar */}
                ...
                <div className="px-4 py-3">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <Link to="/dashboard" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 text-sm">
                                View Site
                            </Link>
                            <button
            ...
            <div className="flex">
                {/* Sidebar */}
                <div className="w-64 bg-white dark:bg-gray-800 shadow-md min-h-[calc(100vh-64px)]">
